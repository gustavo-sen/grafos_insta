...
if __name__ == "__main__":
    ...
    adicionar_aresta(grafo,2, 6)
    adicionar_aresta(grafo,3, 2)
    adicionar_aresta(grafo,4, 5)
    adicionar_aresta(grafo,4, 6)
    adicionar_aresta(grafo,5, 6)
    adicionar_aresta(grafo,5, 7)
    adicionar_aresta(grafo,5, 8)
    adicionar_aresta(grafo,5, 9)
    adicionar_aresta(grafo,6, 4)
    adicionar_aresta(grafo,6, 4)
    adicionar_aresta(grafo,7, 9)
    adicionar_aresta(grafo,8, 9)
    adicionar_aresta(grafo,9, 8)
